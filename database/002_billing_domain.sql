...
-- SaaS subscription = an organization's commercial subscription to NEXORA.
-- WiFi plan = an internet product sold by an organization to its end customers.
-- Purchase/access grant = an end-customer acquisition of a WiFi plan.
